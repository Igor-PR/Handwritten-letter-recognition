...
from EMNIST_Dataset_Loader.emnist_loader import EMNIST
...
log_file = open("summary.logsvm","w")
sys.stdout = log_file

# Load EMNIST Data
print('\nLoading EMNIST Data...')
data = EMNIST('./EMNIST_Dataset_Loader/dataset/')
...
try:
	pickle_in = open('EMNIST_SVM.pickle','rb')
	...
	with open('EMNIST_SVM.pickle','wb') as f:
		pickle.dump(clf, f)
